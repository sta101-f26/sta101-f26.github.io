...
$$
\widehat{ice~duration}=148.11-6.18\times temp
$$

- What is the interpretation of the estimated coefficients?

    - If the average annual temperature is zero degrees celcius, the model predicts that ice endures for 148.11 days on average;
    - If the temperature increases by 1 degree celcius, this predicts a 6.18 day *decrease* in ice duration, on average.
