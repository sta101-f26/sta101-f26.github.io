...
These data have several *categorical* variables: `cut`, `color`, and `clarity`. How are their levels ordered? Does this make sense?
...
If you don't think that the order of the levels makes sense, use `mutate`, `fct_relevel`, and variable assignment to change it:
