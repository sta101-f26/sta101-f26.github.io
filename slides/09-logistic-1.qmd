...
format: 
  revealjs: 
    output-file: 09-logistic-1-slides.html
...
What is the difference between the additive vs. interaction linear model when you run a regression model with one numeric and one categorical predictor?

::: wooclap-choices
- This is a trick question - both models require only numeric predictors.
- Both give you different lines for each group, but the additive model requires the lines be parallel.
- Both give you different lines for each group, but the interaction model requires the lines be parallel.
- Where is John Zito and what have you done with him?
:::
...
ggplot(card_krueger_wide, aes(x = statebin, y = emp_diff)) + 
  ...
  scale_x_continuous(breaks = c(0, 1),
                   labels = c("PA (0)", "NJ (1)")) +
  labs(
    title = "Card and Krueger data from HW 5",
...
![](images/09/spam.png){fig-align="center" width="70%"}
...
![](images/09/head-neck.jpg){fig-align="center"}
...
![](images/09/fico.jpg){fig-align="center" width="60%"}
...
![](images/09/tswift.png){fig-align="center" width="40%"}
...
The slope of the logistic regression model for these data is 0.000272. Which of the following is the best interpretation of this value?

::: wooclap-choices
- If we add one exclamation mark to the model, we predict the probability of an email being spam will increase by 0.000272, on average.
- If we add one exclamation mark to the model, we predict the odds of an email being spam will increase by 0.000272, on average.
- If we add one exclamation mark to the model, we predict the odds of an email being spam to be higher by a factor of e^0.000272 = 1.000272, on average.
- The odds of an email being spam are decreasing in the number of exclamation marks.
:::
...
how do the parameters control the shape of the curve? add a shiny app
...
![](images/09/confusion-matrix.png)
