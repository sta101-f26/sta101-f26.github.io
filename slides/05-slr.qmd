...
text(1.3, b0 + b1*0.8 - 0.5, "1", col = "red")
text(1.9, b0 + b1*0.8 + 0.5, expression(b[1]), col = "red")
```
...
mtext(expression(b[0]), side = 2, at = b0, cex = 1, las = 1, line = 0.5, col = "red")
```
...
## Properties of least squares regression (FYI) {.scrollable}
