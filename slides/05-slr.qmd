...
mtext(expression(y[1]), side = 2, at = yi, cex = 2, line = 1, las = 1)
abline(v = 0)
abline(h = 0)
```
...
mtext(expression(y[2]), side = 2, at = yi, cex = 2, line = 1, las = 1)
abline(v = 0)
abline(h = 0)
```
...
mtext(expression(y[i]), side = 2, at = yi, cex = 2, line = 1, las = 1)
abline(v = 0)
abline(h = 0)
```
...
abline(mymodel, col = "red", lwd = 3)
legend(x = 1.9, y = 3.9, c(expression(~b[0]~" + "~b[1]~"x")), text.col = "red", bty = "n", cex = 1.4)
mtext(expression(hat(y)[i]), side = 2, at = b0 + b1 * xi, cex = 2, line = 1, las = 1, col = "red")
...
text(0.4 * xi, (b0 + b1*xi + yi) / 2, expression(e[i]~" = "~y[i]~" - "~hat(y)[i]))
points(xi, b0 + b1*xi, col = "red", pch = 19, lwd = 3)
```
