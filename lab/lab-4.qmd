...
Fit an additive model that predicts `interest_rate` from `credit_util` and `homeownership`. Display the results, and interpret the first three coefficients estimates listed in the table.

## Task 4

Fit an *interaction* model that predicts `interest_rate` from `credit_util` and `homeownership`. Display the results, and interpret the last coefficient estimate listed in the table.
