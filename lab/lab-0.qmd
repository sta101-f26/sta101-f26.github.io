...
1. Click ![](images/project-none.png){width="30%"} in the upper right;
1. Click ![](images/new-project.png){width="30%"} in the drop-down menu;
1. Click ![](images/version-control.png){width="30%"} in the dialog box;
1. Click ![](images/git.png){width="30%"} in the dialog box;
